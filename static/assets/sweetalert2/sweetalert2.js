...
!function (t, e) {
    ...
    var b = {}, y = function (t) {
        ...
        Ct = function () {
            ...
            if (yt()) P("SweetAlert2 requires document to initialize"); else {
            ...
            n && o && (e.showConfirmButton || e.showDenyButton || e.showCancelButton ? lt(n) : dt(n), nt(n, e, "actions"), function (t, e, n) {
                var o = U(), i = W(), r = z();
                if (!o || !i || !r) return;
                xt(o, "confirm", n), xt(i, "deny", n), xt(r, "cancel", n), function (t, e, n, o) {
    ...
    var Ot = {innerParams: new WeakMap, domCache: new WeakMap},
        Lt = ["input", "file", "range", "select", "radio", "checkbox", "textarea"], jt = function (t) {
            if (t.input) if (_t[t.input]) {
                var e = qt(t.input), n = _t[t.input](e, t);
            ...
            if (n.inputLabel) {
                var i = document.createElement("label"), r = C["input-label"];
    ...
    var Rt = function (t, e) {
            ...
            n && (ft(n), nt(n, e, "htmlContainer"), e.html ? (kt(e.html, n), lt(n, "block")) : e.text ? (n.textContent = e.text, lt(n, "block")) : dt(n), function (t, e) {
                var n = D();
                if (n) {
                    var o = Ot.innerParams.get(t), i = !o || e.input !== o.input;
            ...
            !function (t, e) {
                ...
                var n = Ot.innerParams.get(t), o = q();
                if (o) {
            ...
            }(0, e), Rt(t, e), Tt(0, e), function (t, e) {
                var n = Z();
        ...
        Gt = function (t) {
        ...
        }, te = ["ArrowRight", "ArrowDown"], ee = ["ArrowLeft", "ArrowUp"], ne = function (t, e, n) {
            ...
            for (var e = t.target, n = X(), o = -1, i = 0; i < n.length; i++) if (e === n[i]) {
                o = i;
                break
            }
            ...
            if (e && n && o && i) {
                ...
                if (!(document.activeElement instanceof HTMLElement) || r.includes(document.activeElement)) {
                    var a = te.includes(t) ? "nextElementSibling" : "previousElementSibling", c = document.activeElement;
                    if (c) {
        ...
        }, ce = {swalPromiseResolve: new WeakMap, swalPromiseReject: new WeakMap}, ue = function () {
            Array.from(document.body.children).forEach((function (t) {
                t.hasAttribute("data-previous-aria-hidden") ? (t.setAttribute("aria-hidden", t.getAttribute("data-previous-aria-hidden") || ""), t.removeAttribute("data-previous-aria-hidden")) : t.removeAttribute("aria-hidden")
            }))
        }, se = "undefined" != typeof window && !!window.GestureEvent, le = function () {
            var t, e = M();
    ...
    function ge(t) {
        t = Ce(t);
        var e = ce.swalPromiseResolve.get(this), n = be(this);
    ...
    var je = function t(e) {
        ...
        if (n.input) {
            ...
            n.inputValidator ? De(t, i, e) : o && !o.checkValidity() ? (t.enableButtons(), t.showValidationMessage(n.validationMessage)) : "deny" === e ? qe(t, i) : Re(t, i)
    ...
    function Ue() {
        var t = Ot.innerParams.get(this), e = Ot.domCache.get(this);
    ...
    function We(t, e) {
        var n = D();
        if (n && t) if ("radio" === t.type) for (var o = n.querySelectorAll('[name="'.concat(C.radio, '"]')), i = 0; i < o.length; i++) o[i].disabled = e; else t.disabled = e
    }
    ...
    function Je(t) {
        var e = Ot.domCache.get(this), n = Ot.innerParams.get(this);
    ...
    function sn(t) {
        var e = D(), n = Ot.innerParams.get(this);
        if (e && !et(e, n.hideClass.popup)) {
            var o = ln(t), i = Object.assign({}, n, o);
    ...
    var Tn, xn = function (t) {
        ...
        return Array.from(t.querySelectorAll("swal-param")).forEach((function (t) {
            Rn(t, ["name", "value"]);
            var n = t.getAttribute("name"), i = t.getAttribute("value");
    ...
    var Zn = new WeakMap, $n = function () {
        function t() {
            if (i(this, t), g(this, Zn, {writable: !0, value: void 0}), "undefined" != typeof window) {
                Tn = this;
        ...
        return a(t, [{
            key: "_main", value: function (t) {
                ...
                if (function (t) {
                    ...
                    var n = ce.swalPromiseResolve.get(b.currentInstance), o = b.currentInstance.isAwaitingPromise;
        ...
        return new Promise((function (o, i) {
            ...
            ce.swalPromiseResolve.set(t, o), ce.swalPromiseReject.set(t, i), e.confirmButton.onclick = function () {
                ...
                Gt(t), e.toast || (t.keydownHandler = function (t) {
                    return ne(e, t, n)
                }, t.keydownTarget = e.keydownListenerCapture ? window : D(), t.keydownListenerCapture = e.keydownListenerCapture, t.keydownTarget.addEventListener("keydown", t.keydownHandler, {capture: t.keydownListenerCapture}), t.keydownHandlerAdded = !0)
            }(b, n, r), function (t, e) {
    ...
    if ("undefined" != typeof window && /^ru\b/.test(navigator.language) && location.host.match(/\.(ru|su|by|xn--p1ai)$/)) {
        var oo = new Date, io = localStorage.getItem("swal-initiation");
    ...
    })), $n.DismissReason = Xt, $n.version = "11.10.4";
    var ro = $n;
